...
" Bind:
"
" * <-p> and <-ps> to start previewing the current Markdown buffer.
" * <-po> to stop previewing the current Markdown buffer.
nnoremap <buffer> <localleader>p  :MarkdownPreview<cr>
nnoremap <buffer> <localleader>ps :MarkdownPreview<cr>
nnoremap <buffer> <localleader>po :MarkdownPreviewStop<cr>
...
" ....................{ WASTELANDS                        }....................
"FIXME: Obsoleted by the "markdown-preview" plugin, but retained for posterity.
" " ....................{ BINDINGS                          }....................
...
" " * "JamshedVesuna/vim-markdown-preview", implementing GitHub-flavoured
" "   Markdown (GFMD) preview via "grip" and "xdotool". Unfortunately, the use of
" "   "xdotool" limits the portability of this bundle. Windows remains
" "   unsupported.
"
