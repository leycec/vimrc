...
" {{{ FRONT MATTER
" FIXME: Submit to upstream as a Pull Request. Note that we should probably
" enable this functionality *ONLY* if the user explicitly requests it; ergo, we
" should define a new boolean setting disabled by default and test that boolean
" here. Trivial, in theory; unctuos, in practice.
